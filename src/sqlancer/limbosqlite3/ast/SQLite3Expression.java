package sqlancer.limbosqlite3.ast;
...
import sqlancer.limbosqlite3.SQLite3CollateHelper;
        ...
        public enum BinaryOperator {
            CONCATENATE("||") {
                ...
                public SQLite3Constant apply(SQLite3Constant left, SQLite3Constant right) {
                    ...
                    if (!LimboSQLite3Provider.allowFloatingPointFp && (left.getDataType() == SQLite3DataType.REAL
