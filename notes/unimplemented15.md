...
```sql
-- Time: 2025/07/03 23:02:12
-- Database: database0
-- Database version: 
-- seed value: 1751598132807
CREATE TABLE IF NOT EXISTS  t0 (c0 TEXT DEFAULT x'a2ef60f6' ); -- 1ms;
INSERT INTO t1 VALUES (NULL); -- 0ms;
INSERT INTO t70 VALUES ('1272890769'); -- 0ms;
INSERT INTO t70(c0) VALUES (x'370e'); -- 0ms;
INSERT INTO t70(c0) VALUES (x'45c4'), (-1121783215), (x''); -- 0ms;
INSERT INTO t0 VALUES (-1.121783215E9), (NULL), ('-1121783215'), (NULL), (''); -- 1ms;
CREATE TABLE IF NOT EXISTS t2 (c0 BLOB ); -- 1ms;
...
```txt
java.lang.AssertionError: PRAGMA checkpoint_fullfsync = true;
