...
```sql
-- Time: 2025/07/03 22:49:07
-- Database: database0
-- Database version: 
-- seed value: 1751597316600
CREATE TABLE IF NOT EXISTS t0 (c0 INTEGER , c1 REAL , c2 INT ); -- 1ms;
UPDATE t4 SET c1='n'; -- 0ms;
UPDATE t4 SET (c2)=(-306788244); -- 0ms;
UPDATE t0 SET c0=x''; -- 0ms;
UPDATE t5 SET c0=-98921352; -- 0ms;
CREATE TABLE IF NOT EXISTS  t6 (c0 INTEGER ); -- 1ms;
CREATE TABLE IF NOT EXISTS t7 (c0 REAL ); -- 0ms;
UPDATE t4 SET (c1)=(NULL); -- 0ms;
UPDATE t4 SET (c0)=(-1450378116); -- 0ms;
PRAGMA optimize;
```
...
```txt
java.lang.AssertionError: PRAGMA optimize;
