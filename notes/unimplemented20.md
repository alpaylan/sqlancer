...
```sql
-- Time: 2025/07/03 23:24:29
-- Database: database0
-- Database version: 
-- seed value: 1751599469385
CREATE TABLE IF NOT EXISTS  t0 (c0 INTEGER , c1 TEXT , c2 TEXT ); -- 0ms;
...
```txt
java.lang.AssertionError: PRAGMA short_column_names = false;
