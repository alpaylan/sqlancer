...
```sql
-- Time: 2025/07/03 22:51:22
-- Database: database0
-- Database version: 
-- seed value: 1751597482965
CREATE TABLE IF NOT EXISTS  t0 (c0 REAL , c1 INTEGER , c2 BLOB ); -- 1ms;
UPDATE t2 SET c0='' WHERE NULLIF(0.8237090430957217, t2.c0 COLLATE RTRIM); -- 1ms;
UPDATE t2 SET c0=NULL, c0=-691441659 WHERE (((t2.c0)OR(t2.c0)) IN ()); -- 0ms;
PRAGMA temp.wal_autocheckpoint = -106970692297163304;
```

## rust error

```txt
java.lang.AssertionError: PRAGMA temp.wal_autocheckpoint = -106970692297163304;
