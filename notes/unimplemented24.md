...
```sql
-- Time: 2025/07/03 23:27:42
-- Database: database0
-- Database version: 
-- seed value: 1751599662495
CREATE TABLE IF NOT EXISTS t0 (c0 BLOB ); -- 1ms;
UPDATE t0 SET (c0)=(-489295135); -- 0ms;
UPDATE t70 SET (c0)=(''); -- 1ms;
INSERT INTO t8(c0) VALUES (0.772525814941987); -- 0ms;
UPDATE t1 SET c0=0.3073827422106272; -- 0ms;
INSERT INTO t2 VALUES ('-489295135'), (0xfffffffffa780253), (0X3fb5a3b4); -- 0ms;
PRAGMA threads;
```
...
```txt
java.lang.AssertionError: PRAGMA threads;
