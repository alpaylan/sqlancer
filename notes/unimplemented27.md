...
```sql
-- Time: 2025/07/03 23:43:43
-- Database: database0
-- Database version: 
-- seed value: 1751600623266
CREATE TABLE IF NOT EXISTS t0 (c0 TEXT , c1 INTEGER , c2 BLOB ); -- 1ms;
CREATE TABLE IF NOT EXISTS  t82 (c0 BLOB ); -- 1ms;
INSERT INTO t0(c1, c2) VALUES (NULL, 0.6427781950581348); -- 1ms;
...
```txt
java.lang.AssertionError: PRAGMA main.application_id;
