...
```sql
-- Time: 2025/07/03 23:02:55
-- Database: database0
-- Database version: 
-- seed value: 1751598175912
CREATE TABLE IF NOT EXISTS  t0 (c0 REAL ); -- 0ms;
UPDATE t0 SET c0=0.1505690805258718, c0=NULL, c0=0.7438990349419438 WHERE HEX(t0.c0 COLLATE NOCASE); -- 1ms;
UPDATE t2 SET (c0)=(''); -- 0ms;
UPDATE t0 SET c0=NULL WHERE HEX(t0.c0 COLLATE BINARY); -- 1ms;
PRAGMA default_cache_size = 1039078279;
```

## rust error

```txt
java.lang.AssertionError: PRAGMA default_cache_size = 1039078279;
