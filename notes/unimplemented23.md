...
```sql
-- Time: 2025/07/03 23:26:24
-- Database: database0
-- Database version: 
-- seed value: 1751599584992
CREATE TABLE IF NOT EXISTS t0 (c0 INT ); -- 2ms;
INSERT INTO t1 VALUES (NULL); -- 1ms;
INSERT INTO t1(c0) VALUES (NULL); -- 1ms;
PRAGMA cache_spill;
```
...
java.lang.AssertionError: PRAGMA cache_spill;
