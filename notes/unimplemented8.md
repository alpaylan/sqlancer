...
```sql
-- Time: 2025/07/03 22:46:31
-- Database: database0
-- Database version: 
-- seed value: 1751597191961
CREATE TABLE IF NOT EXISTS t0 (c0 TEXT , c1 REAL , c2 INTEGER ); -- 1ms;
...
```txt
java.lang.AssertionError: PRAGMA cell_size_check;
