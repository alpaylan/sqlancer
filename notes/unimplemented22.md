...
```sql
-- Time: 2025/07/03 23:25:34
-- Database: database0
-- Database version: 
-- seed value: 1751599534606
CREATE TABLE IF NOT EXISTS t0 (c0 BLOB , c1 INTEGER , c2 INTEGER , c3 INTEGER , c4 REAL ); -- 2ms;
UPDATE t5 SET c0=0.15857272904268704; -- 1ms;
UPDATE t1 SET c0=0.023613102128484664 WHERE ((((CAST(t1.c0 AS BLOB))AND(((t1.c0)!=(t1.c0)))))AND(NULL)); -- 0ms;
...
```txt
java.lang.AssertionError: PRAGMA main.reverse_unordered_selects;
